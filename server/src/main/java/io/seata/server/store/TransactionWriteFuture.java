...
public class TransactionWriteFuture {
     ...
     */
    public TransactionWriteFuture(SessionStorable sessionRequest, TransactionStoreManager.LogOperation logOperation) {
     ...
     */
    public TransactionWriteFuture(SessionStorable sessionRequest, TransactionStoreManager.LogOperation logOperation, long timeoutMills) {
