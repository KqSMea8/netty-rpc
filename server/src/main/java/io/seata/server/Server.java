...
public class Server {
    ...
    private static final int MIN_SERVER_POOL_SIZE = 100;//最小线程数
    private static final int MAX_SERVER_POOL_SIZE = 500;//最大线程数
    private static final int MAX_TASK_QUEUE_SIZE = 20000;//队列最大容量
    private static final int KEEP_ALIVE_TIME = 500;//线程存少时间
